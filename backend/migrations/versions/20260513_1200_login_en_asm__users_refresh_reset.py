"""login-en-asm: users, refresh_tokens, password_reset_tokens.

Revision ID: 20260513_1200
...
def upgrade() -> None:
    # Case-insensitive text type for email columns.
