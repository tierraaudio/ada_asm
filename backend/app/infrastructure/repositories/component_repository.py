...
def _to_entity(row: ComponentModel) -> Component:
    return Component(
        ...
        family_inferred_supplier=row.family_inferred_supplier,
        family_inferred_match_type=row.family_inferred_match_type,
        raw_category_id=row.raw_category_id,
        raw_category_name=row.raw_category_name,
        raw_tariff_code=row.raw_tariff_code,
        family_confidence=row.family_confidence,
        family_needs_review=row.family_needs_review,
...
class SqlAlchemyComponentRepository:
    ...
    async def save(self, component: Component) -> Component:
        row = ComponentModel(
            ...
            last_buy_date=component.last_buy_date,
            discontinued=component.discontinued,
            end_of_life=component.end_of_life,
            moq=component.moq,
            order_multiple=component.order_multiple,
            lead_time_days=component.lead_time_days,
            unit_weight_kg=component.unit_weight_kg,
            image_url=component.image_url,
            family_inferred_supplier=component.family_inferred_supplier,
            family_inferred_match_type=component.family_inferred_match_type,
            raw_category_id=component.raw_category_id,
            raw_category_name=component.raw_category_name,
            raw_tariff_code=component.raw_tariff_code,
            family_confidence=component.family_confidence,
            family_needs_review=component.family_needs_review,
        )
